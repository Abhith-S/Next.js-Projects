const getPredictedAge = async (name: string) => {
  ...
  interface Params {
    params: { randName: string };
  }
  
  async function Prediction({ params }: Params) {
    const ageData = getPredictedAge(params.randName);
    const genderData = getPredictedGender(params.randName);
    const nationalityData = getPredictedNationality(params.randName);
